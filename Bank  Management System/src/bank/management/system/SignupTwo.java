...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formnno){
        ...
        String valReligion[] = {"Hindu","Musilm","Sikh","Christian","Others"};
        ...
        String educationvalues[] ={"Non-Graduate", "PG", "UG", "Doctrate", "Others"};
        ...
        String occupationalvalues[] ={"Salared", "Self-Employed", "Business", "Student", "Retiared","Others"};
        ...
        maritalgroup.add(cyes);
        maritalgroup.add(cno);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
               ...
               Conn c = new Conn();
               String q = "insert into signuptwo values('"+formno+"','"+sreligion+"','"+scategory+"','"+sincome+"','"+seducation+"','"+soccupation+"','"+span+"', '"+sadhar+"', '"+sseniorcitizen+"', '"+sexistingaccount+"')";
               c.s.executeUpdate(q);
